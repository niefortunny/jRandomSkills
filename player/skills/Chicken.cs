    ...
    public class Chicken : ISkill
    {
        ...
        public static void EnableSkill(CCSPlayerController player)
        {
            ...
            if (playerPawn != null && playerPawn.IsValid)
            {
                ...
                SkillUtils.ChangePlayerScale(player, .5f);
        ...
        private static void SetWeaponAttack(CCSPlayerController player, bool disableWeapon)
        {
            ...
            if (
                ...
                || pawn.WeaponServices.MyWeapons == null
            )
                return;
        ...
        private static void CreateChicken(CCSPlayerController player)
        {
            ...
            chickenModel.CBodyComponent!.SceneNode!.Owner!.Entity!.Flags = (uint)(
                chickenModel.CBodyComponent!.SceneNode!.Owner!.Entity!.Flags & ~(1 << 2)
            );
