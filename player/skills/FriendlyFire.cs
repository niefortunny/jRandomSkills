...
namespace src.player.skills
{
    public class FriendlyFire : ISkill
    {
        ...
        private static readonly string[] nades =
        [
            "inferno",
            "flashbang",
            "smokegrenade",
        ...
        public static void PlayerHurt(EventPlayerHurt @event)
        {
            ...
            if (playerInfo?.Skill != skillName || attacker!.Team != victim!.Team)
                return;
            ...
            SkillUtils.AddHealth(
                pawn,
                damage + (int)(damage * SkillsInfo.GetValue<float>(skillName, "healthMultiplier")),
                pawn.MaxHealth
            );
        }
