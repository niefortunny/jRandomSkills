...
namespace src.player.skills
{
    public class RobinHood : ISkill
    {
        ...
        )
        {
            ...
            if (victimMoneyServices == null || attackerMoneyServices == null)
                return;

            var moneyToAdd =
                victimMoneyServices.Account < money ? victimMoneyServices.Account : money;
            ...
            attackerMoneyServices.Account = Math.Min(
                attackerMoneyServices.Account + moneyToAdd,
                16000
            );
