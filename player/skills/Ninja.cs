    ...
    public class Ninja : ISkill
    {
        ...
        private static void UpdateNinja(CCSPlayerController? player)
        {
            ...
            if (buttons.HasFlag(PlayerButtons.Duck))
                percentInvisibility += SkillsInfo.GetValue<float>(
                    skillName,
                    "duckPercentInvisibility"
                );
            if (activeWeapon != null && activeWeapon.DesignerName == "weapon_knife")
                percentInvisibility += SkillsInfo.GetValue<float>(
                    skillName,
                    "knifePercentInvisibility"
                );
            if (
        ...
        private static void SetPlayerVisibility(
            CCSPlayerController player,
            float percentInvisibility
        )
        {
            ...
            if (playerPawn != null)
            {
                var color = Color.FromArgb(
                    Math.Max(255 - (int)(255 * percentInvisibility), 0),
                    255,
                    255,
                    255
                );
        ...
        private static void SetWeaponVisibility(
            CCSPlayerController player,
            float percentInvisibility
        )
        {
            ...
            var color = Color.FromArgb(
                Math.Max(255 - (int)(255 * percentInvisibility * 2), 0),
                255,
                255,
                255
            );
        ...
        public class SkillConfig(
            ...
            float idlePercentInvisibility = .3f,
            float duckPercentInvisibility = .3f,
            float knifePercentInvisibility = .3f
        )
