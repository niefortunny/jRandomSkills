...
namespace src.player.skills
{
    public class LongKnife : ISkill
    {
        ...
        public static HookResult ShootSecondary(DynamicHook hook)
        {
            ...
            if (action != actionCode || weapon?.DesignerName != "weapon_knife")
        ...
        private static unsafe void KnifeHit(CCSPlayerController player, bool heavyHit)
        {
            var pawn = player!.PlayerPawn.Value;
