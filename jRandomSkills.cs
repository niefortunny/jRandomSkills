...
#pragma warning restore CS8618
        ...
        public const string Tag = "HSMANIA";
        ...
        public override void Load(bool hotReload)
        {
            ...
            RegisterListener<Listeners.OnServerPrecacheResources>(
                (manifest) => manifest.AddResource("models/actors/ghost_speaker.vmdl")
            );
        }
        ...
        internal void LoadAllSkills()
        {
            ...
            Debug.WriteToDebug(
                $"jRandomSkills v{Instance.ModuleVersion} ({SkillData.Skills.Count - 1}/{SkillsInfo.LoadedConfig.Count - 1} Skills) loaded!"
            );
            Debug.WriteToDebug(
                $"GameModes: {(Config.GameModes)Config.LoadedConfig.GameMode}, Lang: {Config.LoadedConfig.LanguageSystem.DefaultLangCode}"
            );
        ...
        public uint[] footstepSoundEvents =
        [
            3109879199,
            70939233,
            1342713723,
